...
// Create filter for the top ten companies by Year and sort the data in descending order

// function recentStocks(stocks) {
//     return stocks.year > 2022 && stocks.rank < 11;
// }

// let latestStocks = data.filter(recentStocks)

// let sortedStocks = latestStocks.sort(function compareFunction(firstNum,secondNum) {
//     return secondNum - firstNum;
// });

// console.log(latestStocks)

// Create a function to filter and sort the top ten stocks for each year
...
function filterAndSortBySelectedYear(data, selectedYear, maxRank) {
  ...
  let topCompanies2015 = filterAndSortBySelectedYear(data,2015,11)
  let topCompanies2016 = filterAndSortBySelectedYear(data,2016,11)
  let topCompanies2017 = filterAndSortBySelectedYear(data,2017,11)
  let topCompanies2018 = filterAndSortBySelectedYear(data,2018,11)
  let topCompanies2019 = filterAndSortBySelectedYear(data,2019,11)
  let topCompanies2020 = filterAndSortBySelectedYear(data,2020,11)
  let topCompanies2021 = filterAndSortBySelectedYear(data,2021,11)
  let topCompanies2022 = filterAndSortBySelectedYear(data,2022,11)
  let topCompanies2023 = filterAndSortBySelectedYear(data,2023,11)
